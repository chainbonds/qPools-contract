// Check out these files to install solana wallet adapter: https://github.com/solana-labs/wallet-adapter/issues/153
...
const App: NextPage = () => {
  return (
    <div className={styles.container}>
      <Head>
        <title> qPools - Passive Income, Staying Liquid </title>
