...
export class PortfolioFrontendFriendlyChainedInstructions extends SaberInteractToolFrontendFriendly {
    ...
    async createSinglePositionInLiquidityPool(
        ...
        /*
            Basically, don't ever pay in more than the user has.
            Also, don't pay more than is allowed to be allocated

            TODO: Prevent user from creating a second position if he has not done so!
         */
