...
describe('qPools!', () => {
    ...
    it("Create Associated Token Accounts", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (txCreateATA.instructions.length > 0) {
            ...
            yield (0, sdk_1.sendAndConfirmTransaction)(solbondProgram.provider, connection, txCreateATA);
        }
        ...
        const associatedTokenAccountWrappedSol = yield (0, associated_token_account_1.getAssociatedTokenAddress)(wrappedSolMint, genericPayer.publicKey);
    ...
    it("Creates the first transaction", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, sdk_1.sendAndConfirmTransaction)(solbondProgram.provider, connection, tx);
    }));
